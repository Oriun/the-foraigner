 ...
 */
export function BadRequest(response, reason) {
 ...
 */
export function UnAuthorized(response, reason = "You must have a valid authentication or credentials.") {
 ...
 */
export function Forbidden(response, reason = "You don't have access to this ressource.") {
 ...
 */
export function NotFound(response, reason = "Could not find ressource with the specified criterias") {
 ...
 */
export function Unexpected(response, err) {
